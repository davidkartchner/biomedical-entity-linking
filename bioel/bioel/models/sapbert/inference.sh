...
for DATASET in  "ncbi_disease" "bc5cdr" "nlmchem" "nlm_gene" "gnormplus" "medmentions_full" "medmentions_st21pv"
#for DATASET in "medmentions_full"
do
	#MODEL_DIR="/home/pbathala3/entity_linking/biomedical-entity-linking/bioel/bioel/models/sapbert/finetuned_models_pub/${DATASET}"
	...
	--output_dir ./output/with_abbreviations_hugging \

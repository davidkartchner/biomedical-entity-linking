import sys
sys.path.insert(0, "./bioel")

import ontology
from ontology import (BiomedicalOntology, BiomedicalEntity)
...
class KnowledgeBaseEmbeddings:
    ...
    def __init__(
        ...
        self.cui_to_entity: Dict[str, BiomedicalEntity] = {}

        for entity in BiomedicalOntology.entities:
            unique_aliases = set(entity.aliases)
            unique_aliases.add(entity.name)
            for alias in unique_aliases:
                alias_to_cuis[alias].add(entity.cui)
            self.cui_to_entity[entity.cui] = entity

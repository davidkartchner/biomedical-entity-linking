...
import kb_generation
from kb_generation import (KnowledgeBase, load_approximate_nearest_neighbours_index, LinkerPaths, Entity)
...
class CandidateGenerator:
    ...
    def __init__(
        ...
        self.vectorizer = tfidf_vectorizer or joblib.load(
            cached_path(serialized_kb.tfidf_vectorizer)
        )
        self.ann_concept_aliases_list = ann_concept_aliases_list or json.load(
            open(cached_path(serialized_kb.concept_aliases_list))
        )
